...
export const metadata: Metadata = {
  ...
  title: "About Us, Herbert NT",
  description:
    "Elite Manufacturing Group, based at Herbert in the Northern Territory. We own the job end to end, from specification to the keys in your hand.",
};
